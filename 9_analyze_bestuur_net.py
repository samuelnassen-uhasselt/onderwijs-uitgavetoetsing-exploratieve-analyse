...
df_master = pd.read_excel('5_master_ul_dir.xlsx')
df_units = pd.read_excel('8a_analyse_units.xlsx')
...
df_units[df_units['schoolbestuur'] == '[]'].to_excel('9c_units_zonder_bestuur.xlsx', index=False)
...
df_bestuur.to_excel('9a_analyse_bestuur.xlsx', index=False)
...
df_units[df_units['net'] == '[]'].to_excel('9d_units_zonder_net.xlsx', index=False)
...
df_net.to_excel('9b_analyse_net.xlsx', index=False)