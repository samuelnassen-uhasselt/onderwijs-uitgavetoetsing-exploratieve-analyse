...
df_zelfde.to_excel(f'jaren/{sys.argv[1]}/6a_vestigingen_zelfde_adres_bestuur.xlsx', index=False)
...
df_clusters.to_excel(f'jaren/{sys.argv[1]}/6b_clusters_zelfde_adres_en_bestuur.xlsx', index=False)