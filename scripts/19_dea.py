...
df_units_2022['kost_per_leerling_laatste'] = df_units_2022[
    'input_laatste_jaar_asis']/df_units_2022['leerlingen_laatste_jaar']
df_units_2022['doorstroom_percentage'] = df_units_2022['rechtstreeks_HO']/df_units_2022['loopbanen_HO']

input = {
    'kolom': 'kost_per_leerling_laatste',
...
input_col = 'kost_per_leerling_laatste'
