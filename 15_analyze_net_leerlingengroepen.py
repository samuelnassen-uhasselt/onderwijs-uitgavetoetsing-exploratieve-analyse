...
df = pd.read_excel('8a_analyse_units.xlsx')
...
df.to_excel('15b_unit_net_llngroepen.xlsx', index=False)
...
df_exploded.to_excel('15a_analyse_net_llngroepen.xlsx', index=False)