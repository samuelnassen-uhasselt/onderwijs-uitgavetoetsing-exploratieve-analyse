...
df = pd.read_excel('output/8a_analyse_units.xlsx')
...
df.to_excel('output/15b_unit_net_llngroepen.xlsx', index=False)
...
df_exploded.to_excel('output/15a_analyse_net_llngroepen.xlsx', index=False)