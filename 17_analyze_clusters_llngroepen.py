...
df_adres = pd.read_excel('output/7_analyse_clusters_zelfde_adres.xlsx')
df_straal = pd.read_excel('output/14_analyse_clusters_straal_100m.xlsx')
...
df_adres_exploded = get_exploded_df(df_adres, ['cluster'], 'llngr_aantallen')
...
df_straal_exploded = get_exploded_df(df_straal, ['cluster'], 'llngr_aantallen')
